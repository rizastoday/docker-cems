...
!(function (t, e) {
    ...
    if (K) {
        var $ = K.fn[F];
        (K.fn[F] = V.jQueryInterface),
            (K.fn[F].Constructor = V),
            (K.fn[F].noConflict = function () {
    ...
    if (it) {
        var ot = it.fn.button;
        (it.fn.button = nt.jQueryInterface),
            (it.fn.button.Constructor = nt),
            (it.fn.button.noConflict = function () {
    ...
    var at = {
        ...
        dt = { interval: "(number|boolean)", keyboard: "boolean", slide: "(boolean|string)", pause: "(string|boolean)", wrap: "boolean", touch: "boolean" },
        ht = "slid" + ut,
            ...
            return (
                ...
                (n.to = function (t) {
                    ...
                    if (!(t > this._items.length - 1 || t < 0))
                        if (this._isSliding)
                            q.one(this._element, ht, function () {
                                return e.to(t);
                            });
                        else {
                ...
                (n._addTouchEventListeners = function () {
                    var t = this,
                        ...
                        n = function (e) {
                            t._pointerEvent && pt[e.pointerType.toUpperCase()] && (t.touchDeltaX = e.clientX - t.touchStartX),
                                t._handleSwipe(),
                        ...
                        if (((this._isSliding = !0), u && this.pause(), this._setActiveIndicatorElement(l), this._element.classList.contains("slide"))) {
                            ...
                            q.one(s, "transitionend", function () {
                                l.classList.remove(n, i),
                                    ...
                                    (r._isSliding = !1),
                                    setTimeout(function () {
                                        q.trigger(r._element, ht, { relatedTarget: l, direction: o, from: a, to: c });
                                    }, 0);
                            }),
                                m(s, d);
                        } else s.classList.remove("active"), l.classList.add("active"), (this._isSliding = !1), q.trigger(this._element, ht, { relatedTarget: l, direction: o, from: a, to: c });
                        u && this.cycle();
                    }
                }),
    ...
    q.on(document, "click.coreui.carousel.data-api", "[data-slide], [data-slide-to]", gt.dataApiClickHandler),
    ...
    if (mt) {
        var vt = mt.fn[lt];
        (mt.fn[lt] = gt.jQueryInterface),
            (mt.fn[lt].Constructor = gt),
            (mt.fn[lt].noConflict = function () {
                                ...
                                if (r) {
                                    ...
                                    if (
                                        ...
                                        c.forEach(function (t) {
                                            ...
                                            var e = new CustomEvent("classtoggle", { detail: { target: i, add: !1, className: t } });
                                            n.dispatchEvent(e);
                                        });
                                    else {
                                        n.classList.add(o);
                                        var f = new CustomEvent("classtoggle", { detail: { target: i, add: !0, className: o } });
                                        n.dispatchEvent(f);
                                    }
                                } else {
                                    var d = n.classList.toggle(o),
                                        h = new CustomEvent("classtoggle", { detail: { target: i, add: d, className: o } });
                                    n.dispatchEvent(h);
                                }
                            });
                    });
                ...
                (n._getToggleDetails = function (t, e, n, i) {
                    ...
                    return (
                        Array.isArray(t)
                            ...
                            : ((n = e ? n : null), (i = e ? i : null), r.push(new o(t, e, n, i))),
                        r
                    );
                }),
                ...
                (n._getElementDataAttributes = function (t) {
                    ...
                    return (
                        Array.isArray(i)
                            ...
                            : l.push(new c(i, this._getToggleDetails(o, r, s, a))),
                        l
                    );
                }),
    ...
    if (kt) {
        var Tt = kt.fn[_t];
        (kt.fn[_t] = Lt.jQueryInterface),
            (kt.fn[_t].Constructor = Lt),
            (kt.fn[_t].noConflict = function () {
            ...
            return (
                ...
                (n.show = function () {
                    ...
                    if (!this._isTransitioning && !this._element.classList.contains("show")) {
                        ...
                        this._parent &&
                            0 ===
                                (n = tt.find(".show, .collapsing", this._parent).filter(function (t) {
                ...
                (n._getParent = function () {
                    ...
                    return (
                        tt.find(n, e).forEach(function (e) {
                            var n = d(e);
    ...
    if (xt) {
        var jt = xt.fn[At];
        (xt.fn[At] = Dt.jQueryInterface),
            (xt.fn[At].Constructor = Dt),
            (xt.fn[At].noConflict = function () {
                ...
                (("body" !== Ht(e) || Bt(o)) &&
                    (s =
                        (i = e) !== It(i) && Mt(i)
                            ...
                            : Pt(i)),
                Mt(e) ? (((a = Nt(e)).x += e.clientLeft), (a.y += e.clientTop)) : o && (a.x = Yt(o))),
            { x: r.left + s.scrollLeft - a.x, y: r.top + s.scrollTop - a.y, width: r.width, height: r.height }
        );
    }
    function qt(t) {
    ...
    function le(t) {
        ...
        return function (t, e, n) {
            ...
            var o,
                s,
                a = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, se, {}, r), modifiersData: {}, elements: { reference: t, popper: e }, attributes: {}, styles: {} },
                l = [],
                c = !1,
                u = {
                    state: a,
                    setOptions: function (n) {
                        f(), (a.options = Object.assign({}, r, {}, a.options, {}, n)), (a.scrollParents = { reference: Rt(t) ? Qt(t) : t.contextElement ? Qt(t.contextElement) : [], popper: Qt(e) });
                        var o,
                            s,
                            c = (function (t) {
                                var e = oe(t);
                    ...
                    forceUpdate: function () {
                        if (!c) {
                            var t = a.elements,
                                ...
                                n = t.popper;
                            if (ae(e, n)) {
                                (a.rects = { reference: Ut(e, Kt(n), "fixed" === a.options.strategy), popper: qt(n) }),
                                    (a.reset = !1),
    ...
    function pe(t) {
        ...
        var _,
            b = Object.assign({ position: s }, l && he);
        return a
            ? Object.assign({}, b, (((_ = {})[g] = h ? "0" : ""), (_[p] = d ? "0" : ""), (_.transform = (m.devicePixelRatio || 1) < 2 ? "translate(" + u + "px, " + f + "px)" : "translate3d(" + u + "px, " + f + "px, 0)"), _))
            : Object.assign({}, b, (((e = {})[g] = h ? f + "px" : ""), (e[p] = d ? u + "px" : ""), (e.transform = ""), e));
    }
    ...
    function ye(t) {
        var e = It(t),
            n = (function (t) {
                var e = Mt(t) ? Xt(t) : {};
                return { top: be(e.borderTopWidth), right: be(e.borderRightWidth), bottom: be(e.borderBottomWidth), left: be(e.borderLeftWidth) };
            })(t),
            i = "html" === Ht(t),
            o = Yt(t),
        ...
        return (
            i && e.innerHeight - t.clientHeight > 50 && (s = e.innerHeight - n.bottom),
            { top: i ? 0 : t.clientTop, right: t.clientLeft > n.left ? n.right : i ? e.innerWidth - r - o : t.offsetWidth - r, bottom: i ? e.innerHeight - s : t.offsetHeight - s, left: i ? o : t.clientLeft }
        );
    }
    function we(t, e) {
            ...
            ? Ee(
                  (function (t) {
                      var e = It(t),
                          ...
                          i = e.innerWidth,
                          o = e.innerHeight;
                      return n && /iPhone|iPod|iPad/.test(navigator.platform) && ((i = n.width), (o = n.height)), { width: i, height: o, x: 0, y: 0 };
                  })(t)
              )
            : Mt(e)
            ? Nt(e)
    ...
    function Oe(t, e) {
        ...
        var n = e,
            ...
            w = Nt(v),
            E = de({ reference: w, element: _, strategy: "absolute", placement: o }),
            L = Ee(Object.assign({}, _, {}, E)),
            k = "popper" === u ? L : w,
            T = { top: y.top - k.top + g.top, bottom: k.bottom - y.bottom + g.bottom, left: y.left - k.left + g.left, right: k.right - y.right + g.right },
    ...
    function Se(t, e) {
        ...
        var n = e,
            ...
            f = (u
                ...
                .reduce(function (e, n) {
                    return (e[n] = Oe(t, { placement: n, boundary: o, rootBoundary: r, padding: s })[re(n)]), e;
                }, {});
    ...
    var je = le({
            defaultModifiers: [
                ...
                },
                {
                    ...
                    fn: function (t) {
                        var e = t.state,
                            n = t.name;
                        e.modifiersData[n] = de({ reference: e.rects.reference, element: e.rects.popper, strategy: "absolute", placement: e.placement });
                    },
                    data: {},
                },
                {
                    ...
                    fn: function (t) {
                        var e = t.state,
                            ...
                            r = n.adaptive,
                            s = void 0 === r || r,
                            a = { placement: re(e.placement), popper: e.elements.popper, popperRect: e.rects.popper, gpuAcceleration: o };
                        null != e.modifiersData.popperOffsets && (e.styles.popper = Object.assign({}, e.styles.popper, {}, pe(Object.assign({}, a, { offsets: e.modifiersData.popperOffsets, position: e.options.strategy, adaptive: s })))),
                            null != e.modifiersData.arrow && (e.styles.arrow = Object.assign({}, e.styles.arrow, {}, pe(Object.assign({}, a, { offsets: e.modifiersData.arrow, position: "absolute", adaptive: !1 })))),
                                ...
                                return (
                                    (t[n] = (function (t, e, n) {
                                        var i = re(t),
                                            ...
                                            s = r[0],
                                            a = r[1];
                                        return (s = s || 0), (a = (a || 0) * o), [Zt, Gt].indexOf(i) >= 0 ? { x: a, y: s } : { x: s, y: a };
                                    })(n, e.rects, r)),
                                    t
                                );
                            }, {}),
                            ...
                            for (
                                var o = n.mainAxis,
                                    ...
                                    b = [m].concat(_).reduce(function (t, n) {
                                        return t.concat("auto" === re(n) ? Se(e, { placement: n, boundary: u, rootBoundary: f, padding: c, flipVariations: p, allowedAutoPlacements: g }) : n);
                                    }, []),
                                    y = e.rects.reference,
                                    w = e.rects.popper,
                                    E = new Map(),
                                ...
                                var A = b[T],
                                    ...
                                    C = [$t, Jt].indexOf(O) >= 0,
                                    D = C ? "width" : "height",
                                    x = Oe(e, { placement: A, boundary: u, rootBoundary: f, altBoundary: d, padding: c }),
                                    j = C ? (S ? Gt : Zt) : S ? Jt : $t;
                                y[D] > w[D] && (j = me(j));
                                var N = me(j),
                                    I = [];
                ...
                },
                {
                    ...
                    fn: function (t) {
                        var e = t.state,
                            ...
                            p = n.tetherOffset,
                            g = void 0 === p ? 0 : p,
                            m = Oe(e, { boundary: l, rootBoundary: c, padding: f, altBoundary: u }),
                            v = re(e.placement),
                            _ = ue(e.placement),
                            b = !_,
                            y = fe(v),
                ...
                },
                {
                    ...
                    effect: function (t) {
                        ...
                        null != r &&
                            ...
                            we(e.elements.popper, r) &&
                            ((e.elements.arrow = r), (e.modifiersData[i + "#persistent"] = { padding: Te("number" != typeof a ? a : Ae(a, te)) }));
                    },
                    requires: ["popperOffsets"],
                ...
                },
                {
                    ...
                    fn: function (t) {
                        var e = t.state,
                            ...
                            s = Oe(e, { elementContext: "reference" }),
                        ...
                        (e.modifiersData[n] = { referenceClippingOffsets: l, popperEscapeOffsets: c, isReferenceHidden: u, hasPopperEscaped: f }),
                            (e.attributes.popper = Object.assign({}, e.attributes.popper, { "data-popper-reference-hidden": u, "data-popper-escaped": f }));
                    },
                },
            ],
        }),
        ...
        He = { offset: "(array|function)", flip: "boolean", boundary: "(string|element)", reference: "(string|element)", display: "string", popperConfig: "(null|object)" },
        We = (function () {
            function t(t, e) {
                (this._element = t),
                    (this._popper = null),
            ...
            return (
                    ...
                    if (!(this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))) {
                        ...
                        if (!q.trigger(e, "show.coreui.dropdown", n).defaultPrevented) {
                            if (!this._inNavbar && !this._inHeader) {
                                ...
                                var i = this._element;
                                "parent" === this._config.reference ? (i = e) : g(this._config.reference) && ((i = this._config.reference), "undefined" != typeof this._config.reference.jquery && (i = this._config.reference[0])),
                                    "scrollParent" !== this._config.boundary && e.classList.add("position-static"),
                                    (this._popper = je(i, this._menu, this._getPopperConfig()));
                            }
                            var o, r;
                ...
                (t.dataApiKeydownHandler = function (e) {
                    if (
                        !(/input|textarea/i.test(e.target.tagName) ? "Space" === e.key || ("Escape" !== e.key && (("ArrowDown" !== e.key && "ArrowUp" !== e.key) || e.target.closest(".dropdown-menu"))) : !Re.test(e.key)) &&
    ...
    q.on(document, "keydown.coreui.dropdown.data-api", '[data-toggle="dropdown"]', We.dataApiKeydownHandler),
        q.on(document, "keydown.coreui.dropdown.data-api", ".dropdown-menu", We.dataApiKeydownHandler),
        q.on(document, "click.coreui.dropdown.data-api", We.clearMenus),
        q.on(document, "keyup.coreui.dropdown.data-api", We.clearMenus),
        q.on(document, "click.coreui.dropdown.data-api", '[data-toggle="dropdown"]', function (t) {
    ...
    if (Ye) {
        var Xe = Ye.fn[Ne];
        (Ye.fn[Ne] = We.jQueryInterface),
            (Ye.fn[Ne].Constructor = We),
            (Ye.fn[Ne].noConflict = function () {
    ...
    var Be = ".coreui.modal",
        ...
        Fe = (function () {
            function t(t, e) {
                (this._config = this._getConfig(e)),
                    (this._element = t),
                    (this._dialog = tt.findOne(".modal-dialog", t)),
                    (this._backdrop = null),
                    (this._isShown = !1),
            ...
            return (
                ...
                (n.show = function (t) {
                    ...
                    if (!this._isShown && !this._isTransitioning) {
                        ...
                        var n = q.trigger(this._element, "show.coreui.modal", { relatedTarget: t });
                        this._isShown ||
                            n.defaultPrevented ||
                            ((this._isShown = !0),
                            ...
                            q.on(this._element, "click.dismiss.coreui.modal", '[data-dismiss="modal"]', function (t) {
                                return e.hide(t);
                            }),
                ...
                (n.hide = function (t) {
                    ...
                    if ((t && t.preventDefault(), this._isShown && !this._isTransitioning) && !q.trigger(this._element, "hide.coreui.modal").defaultPrevented) {
                        ...
                        if (
                            ...
                            this._setEscapeEvent(),
                            this._setResizeEvent(),
                            q.off(document, "focusin.coreui.modal"),
                            this._element.classList.remove("show"),
                            q.off(this._element, "click.dismiss.coreui.modal"),
                            q.off(this._dialog, "mousedown.dismiss.coreui.modal"),
                            n)
                        ) {
                ...
                (n._enforceFocus = function () {
                    var t = this;
                    q.off(document, "focusin.coreui.modal"),
                        q.on(document, "focusin.coreui.modal", function (e) {
                ...
                (n._setEscapeEvent = function () {
                    var t = this;
                    this._isShown
                        ? q.on(this._element, "keydown.dismiss.coreui.modal", function (e) {
                ...
                (n._setResizeEvent = function () {
                    var t = this;
                    this._isShown
                        ? q.on(window, "resize.coreui.modal", function () {
                ...
                (n._showBackdrop = function (t) {
                    ...
                    if (this._isShown && this._config.backdrop) {
                        if (
                            ...
                            q.on(this._element, "click.dismiss.coreui.modal", function (t) {
    ...
    q.on(document, "click.coreui.modal.data-api", '[data-toggle="modal"]', function (t) {
        ...
        ("A" !== this.tagName && "AREA" !== this.tagName) || t.preventDefault(),
            q.one(n, "show.coreui.modal", function (t) {
                t.defaultPrevented ||
                    q.one(n, "hidden.coreui.modal", function () {
                        _(e) && e.focus();
                    });
            });
    ...
    if (Qe) {
        var ze = Qe.fn.modal;
        (Qe.fn.modal = Fe.jQueryInterface),
            (Qe.fn.modal.Constructor = Fe),
            (Qe.fn.modal.noConflict = function () {
    ...
    var Ze = "tooltip",
        ...
        rn = { AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left" },
        sn = {
            animation: !0,
        ...
        ln = (function () {
            function t(t, e) {
                ...
                (this._isEnabled = !0),
                    ...
                    (this.tip = null),
                    this._setListeners(),
                    L(t, this.constructor.DATA_KEY, this);
            }
            var n = t.prototype;
            return (
                (n.enable = function () {
                ...
                (n.show = function () {
                    ...
                    if (this.isWithContent() && this._isEnabled) {
                        ...
                        if (
                            (L(o, this.constructor.DATA_KEY, this),
                            ...
                            (this._popper = je(this.element, o, this._getPopperConfig(l))),
                ...
                (n.setElementContent = function (t, e) {
                    if (null !== t)
                        return "object" == typeof e && g(e)
                            ...
                            : void (this.config.html ? (this.config.sanitize && (e = Ge(e, this.config.whiteList, this.config.sanitizeFn)), (t.innerHTML = e)) : (t.textContent = e));
                }),
                (n.getTitle = function () {
                ...
                (n._enter = function (t, e) {
                    ...
                    (e = e || k(t.target, n)) || ((e = new this.constructor(t.target, this._getDelegateConfig())), L(t.target, n, e)),
                ...
                (n._getConfig = function (t) {
                    ...
                    return (
                        ...
                        v(Ze, t, this.constructor.DefaultType),
                        t.sanitize && (t.template = Ge(t.template, t.whiteList, t.sanitizeFn)),
                        t
                    );
                }),
    ...
    if (cn) {
        var un = cn.fn[Ze];
        (cn.fn[Ze] = ln.jQueryInterface),
            (cn.fn[Ze].Constructor = ln),
            (cn.fn[Ze].noConflict = function () {
    ...
    var fn = "popover",
        ...
        mn = o(o({}, ln.DefaultType), {}, { content: "(string|element|function)" }),
        vn = {
            HIDE: "hide" + hn,
            HIDDEN: "hidden" + hn,
            SHOW: "show" + hn,
    ...
    if (bn) {
        var yn = bn.fn[fn];
        (bn.fn[fn] = _n.jQueryInterface),
            (bn.fn[fn].Constructor = _n),
            (bn.fn[fn].noConflict = function () {
    ...
    var wn = "scrollspy",
        ...
        Tn = (function () {
            ...
            return (
                ...
                (n.dispose = function () {
                    T(this._element, En),
                        q.off(this._scrollElement, ".coreui.scrollspy"),
                        (this._element = null),
                ...
                (n._activate = function (t) {
                    ...
                    n.classList.contains("dropdown-item")
                        ? (tt.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add("active"), n.classList.add("active"))
                        : (n.classList.add("active"),
                          tt.parents(n, ".nav, .list-group").forEach(function (t) {
    ...
    if (An) {
        var On = An.fn[wn];
        (An.fn[wn] = Tn.jQueryInterface),
            (An.fn[wn].Constructor = Tn),
            (An.fn[wn].noConflict = function () {
    ...
    function Qn(t, e, n, i, o) {
        ...
        !(function (t, e, n, i, o) {
            ...
            e &&
                (f.dispatchEvent(Fn("ps-scroll-" + l)),
                e < 0 ? f.dispatchEvent(Fn("ps-scroll-" + c)) : e > 0 && f.dispatchEvent(Fn("ps-scroll-" + u)),
                i &&
                    (function (t, e) {
                        Yn(t, e), Xn(t, e);
                    })(t, l));
    ...
    function Kn(t) {
        ...
        (t.containerWidth = Math.ceil(i.width)),
            ...
            e.contains(t.scrollbarXRail) ||
                (In(e, Mn.rail("x")).forEach(function (t) {
                    return Nn(t);
                }),
                e.appendChild(t.scrollbarXRail)),
            e.contains(t.scrollbarYRail) ||
                (In(e, Mn.rail("y")).forEach(function (t) {
                    return Nn(t);
                }),
            ...
            !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth
                ? ((t.scrollbarXActive = !0),
                  ...
                  (t.scrollbarXWidth = $n(t, zn((t.railXWidth * t.containerWidth) / t.contentWidth))),
                  (t.scrollbarXLeft = zn(((t.negativeScrollAdjustment + e.scrollLeft) * (t.railXWidth - t.scrollbarXWidth)) / (t.contentWidth - t.containerWidth))))
                : (t.scrollbarXActive = !1),
            !t.settings.suppressScrollY && t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight
                ? ((t.scrollbarYActive = !0),
                  (t.railYHeight = t.containerHeight - t.railYMarginHeight),
                  (t.railYRatio = t.containerHeight / t.railYHeight),
                  (t.scrollbarYHeight = $n(t, zn((t.railYHeight * t.containerHeight) / t.contentHeight))),
                  (t.scrollbarYTop = zn((n * (t.railYHeight - t.scrollbarYHeight)) / (t.contentHeight - t.containerHeight))))
            ...
            (function (t, e) {
                ...
                Cn(e.scrollbarYRail, o), Cn(e.scrollbarX, { left: e.scrollbarXLeft, width: e.scrollbarXWidth - e.railBorderXWidth }), Cn(e.scrollbarY, { top: e.scrollbarYTop, height: e.scrollbarYHeight - e.railBorderYWidth });
            })(e, t),
            t.scrollbarXActive ? e.classList.add(Hn.active("x")) : (e.classList.remove(Hn.active("x")), (t.scrollbarXWidth = 0), (t.scrollbarXLeft = 0), (e.scrollLeft = !0 === t.isRtl ? t.contentWidth : 0)),
            t.scrollbarYActive ? e.classList.add(Hn.active("y")) : (e.classList.remove(Hn.active("y")), (t.scrollbarYHeight = 0), (t.scrollbarYTop = 0), (e.scrollTop = 0));
    }
    function $n(t, e) {
    ...
    var Gn = {
            ...
            "drag-thumb": function (t) {
                Jn(t, ["containerWidth", "contentWidth", "pageX", "railXWidth", "scrollbarX", "scrollbarXWidth", "scrollLeft", "x", "scrollbarXRail"]),
                    Jn(t, ["containerHeight", "contentHeight", "pageY", "railYHeight", "scrollbarY", "scrollbarYHeight", "scrollTop", "y", "scrollbarYRail"]);
            },
            keyboard: function (t) {
                var e = t.element;
        ...
        Zn = function (t, e) {
            ...
            (this.isRtl = "rtl" === Sn(t).direction),
                !0 === this.isRtl && t.classList.add(Rn),
                ...
                (this.scrollbarXRail = Dn(Mn.rail("x"))),
                t.appendChild(this.scrollbarXRail),
                (this.scrollbarX = Dn(Mn.thumb("x"))),
            ...
            (this.scrollbarXBottom = parseInt(l.bottom, 10)),
                isNaN(this.scrollbarXBottom) ? ((this.isScrollbarXUsingBottom = !1), (this.scrollbarXTop = zn(l.top))) : (this.isScrollbarXUsingBottom = !0),
                (this.railBorderXWidth = zn(l.borderLeftWidth) + zn(l.borderRightWidth)),
                Cn(this.scrollbarXRail, { display: "block" }),
                (this.railXMarginWidth = zn(l.marginLeft) + zn(l.marginRight)),
                Cn(this.scrollbarXRail, { display: "" }),
                (this.railXWidth = null),
                (this.railXRatio = null),
                (this.scrollbarYRail = Dn(Mn.rail("y"))),
                t.appendChild(this.scrollbarYRail),
                (this.scrollbarY = Dn(Mn.thumb("y"))),
            ...
            (this.scrollbarYRight = parseInt(c.right, 10)),
                isNaN(this.scrollbarYRight) ? ((this.isScrollbarYUsingRight = !1), (this.scrollbarYLeft = zn(c.left))) : (this.isScrollbarYUsingRight = !0),
                (this.scrollbarYOuterWidth = this.isRtl
                    ...
                    : null),
                (this.railBorderYWidth = zn(c.borderTopWidth) + zn(c.borderBottomWidth)),
                Cn(this.scrollbarYRail, { display: "block" }),
                (this.railYMarginHeight = zn(c.marginTop) + zn(c.marginBottom)),
                Cn(this.scrollbarYRail, { display: "" }),
    ...
    (Zn.prototype.update = function () {
        this.isAlive &&
            ...
            Cn(this.scrollbarXRail, { display: "block" }),
            Cn(this.scrollbarYRail, { display: "block" }),
            (this.railXMarginWidth = zn(Sn(this.scrollbarXRail).marginLeft) + zn(Sn(this.scrollbarXRail).marginRight)),
            (this.railYMarginHeight = zn(Sn(this.scrollbarYRail).marginTop) + zn(Sn(this.scrollbarYRail).marginBottom)),
            Cn(this.scrollbarXRail, { display: "none" }),
            Cn(this.scrollbarYRail, { display: "none" }),
            Kn(this),
            Qn(this, "top", 0, !1, !0),
            Qn(this, "left", 0, !1, !0),
            Cn(this.scrollbarXRail, { display: "" }),
        ...
        (Zn.prototype.onScroll = function (t) {
            this.isAlive &&
                (Kn(this),
                Qn(this, "top", this.element.scrollTop - this.lastScrollTop),
                Qn(this, "left", this.element.scrollLeft - this.lastScrollLeft),
        ...
        (Zn.prototype.destroy = function () {
            this.isAlive &&
                ...
                Nn(this.scrollbarX),
                Nn(this.scrollbarY),
                Nn(this.scrollbarXRail),
                Nn(this.scrollbarYRail),
    ...
    var ti = "sidebar",
        ei = { breakpoints: { xs: "c-sidebar-show", sm: "c-sidebar-sm-show", md: "c-sidebar-md-show", lg: "c-sidebar-lg-show", xl: "c-sidebar-xl-show" }, dropdownAccordion: !0 },
        ni = { breakpoints: "object", dropdownAccordion: "(string|boolean)" },
        ii = (function () {
            function t(t, e) {
            ...
            return (
                ...
                (n.reset = function () {
                    this._element.classList.contains("c-sidebar-minimized") && (this._element.classList.remove("c-sidebar-minimized"), (this._minimize = !1), q.one(this._element, "transitionend", this._psInit())),
                        this._element.classList.contains("c-sidebar-unfoldable") && (this._element.classList.remove("c-sidebar-unfoldable"), (this._unfoldable = !1));
                }),
                (n._getConfig = function (t) {
                ...
                (n._showBackdrop = function () {
                    this._backdrop ||
                        ...
                        document.body.appendChild(this._backdrop),
                        y(this._backdrop),
                        this._backdrop.classList.add("c-show"));
                }),
                ...
                (n._toggleDropdown = function (t, e) {
                    ...
                    "undefined" != typeof i.dropdownAccordion && (ei.dropdownAccordion = JSON.parse(i.dropdownAccordion)),
                        !0 === ei.dropdownAccordion &&
                            this._getAllSiblings(n.parentElement).forEach(function (t) {
                                t !== n.parentNode && t.classList.contains("c-sidebar-nav-dropdown") && t.classList.remove("c-show");
                            }),
                        n.parentNode.classList.toggle("c-show"),
                        e._psUpdate();
                }),
                (n._psInit = function () {
                    this._element.querySelector(".c-sidebar-nav") && !this._isIOS() && (this._ps = new Zn(this._element.querySelector(".c-sidebar-nav"), { suppressScrollX: !0, wheelPropagation: !1 }));
                }),
                    ...
                    Array.from(this._element.querySelectorAll(".c-sidebar-nav-link")).forEach(function (e) {
                        ...
                        "#" ===
                            ...
                            e.href === n &&
                                ...
                                Array.from(t._getParents(e, ".c-sidebar-nav-dropdown")).forEach(function (t) {
                ...
                (n._addEventListeners = function () {
                    ...
                    this._mobile && this._open && this._addClickOutListener(),
                        ...
                        q.on(this._element, "classtoggle", function (e) {
                            if (
                                ("c-sidebar-minimized" === e.detail.className && (t._element.classList.contains("c-sidebar-minimized") ? t.minimize() : t.reset()),
                                "c-sidebar-unfoldable" === e.detail.className && (t._element.classList.contains("c-sidebar-unfoldable") ? t.unfoldable() : t.reset()),
                                "undefined" !=
                                    typeof Object.keys(ei.breakpoints).find(function (t) {
    ...
    if (oi) {
        var ri = oi.fn[ti];
        (oi.fn[ti] = ii.jQueryInterface),
            (oi.fn[ti].Constructor = ii),
            (oi.fn[ti].noConflict = function () {
        ...
        return (
            ...
            (n._transitionComplete = function (t, e, n) {
                ...
                t.parentNode && t.parentNode.classList.contains("dropdown-menu")) &&
                    (t.closest(".dropdown") &&
                        tt.find(".dropdown-toggle").forEach(function (t) {
                            return t.classList.add("active");
                        }),
    ...
    if (ai) {
        var li = ai.fn.tab;
        (ai.fn.tab = si.jQueryInterface),
            (ai.fn.tab.Constructor = si),
            (ai.fn.tab.noConflict = function () {
            ...
            return (
                ...
                (n.dispose = function () {
                    clearTimeout(this._timeout),
                        ...
                        q.off(this._element, "click.dismiss.coreui.toast"),
    ...
    if (vi) {
        var _i = vi.fn.toast;
        (vi.fn.toast = mi.jQueryInterface),
            (vi.fn.toast.Constructor = mi),
            (vi.fn.toast.noConflict = function () {
    ...
    return (
        ...
        { AsyncLoad: V, Alert: J, Button: nt, Carousel: gt, ClassToggler: Lt, Collapse: Dt, Dropdown: We, Modal: Fe, Popover: _n, Scrollspy: Tn, Sidebar: ii, Tab: si, Toast: mi, Tooltip: ln }
    );
});
